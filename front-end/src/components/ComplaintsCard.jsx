      ...
      >
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-4 md:gap-8 flex-1">
          <div className="flex flex-col items-center flex-shrink-0">
            <span className="text-xs md:text-sm font-bold mb-1 text-center break-all max-w-[80px] sm:max-w-none">
              {complaint.code}
            </span>
            ...
            {userType !== "citizen" && (
              <p className="text-center sm:mt-2 font-medium text-xs md:text-sm break-words max-w-[100px] sm:max-w-none">
                {user.name}
              </p>
            )}
          </div>
          ...
          <div className="flex-1 min-w-0 space-y-1 sm:space-y-2 text-center sm:text-left">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-2">
              ...
              />
              <span className="text-xs md:text-sm break-words min-w-0">
